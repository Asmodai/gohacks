...
func TestClientDI(t *testing.T) {
	t.Run("SetClient", func(t *testing.T) {
		inst := NewDefaultClient()
		_, err := SetClient(context.Background(), inst)
		if err != nil {
	...
	t.Run("GetClient", func(t *testing.T) {
		inst := NewDefaultClient()
		ctx, err := SetClient(context.Background(), inst)
		if err != nil {
			t.Fatalf("Unexpected error: %#v", err)
		}

		res, err := GetClient(ctx)
		if err != nil {
			t.Fatalf("Unexpected error: %#v", err)
		}
	...
	t.Run("MustGetClient", func(t *testing.T) {
		t.Run("Panic when missing", func(t *testing.T) {
			ctx := context.Background()
			panicMsg := "Client missing in context"
			...
			_ = MustGetClient(ctx) // should panic
		})

		t.Run("No panic when present", func(t *testing.T) {
			ctx, err := SetClient(context.Background(), NewDefaultClient())
			if err != nil {
				t.Fatalf("Unexpected error: %v", err)
			}
	...
	t.Run("TryGetClient", func(t *testing.T) {
		var zero Client
		...
		t.Run("Returns zero when not present", func(t *testing.T) {
			val, ok := TryGetClient(context.Background())
	...
	t.Run("FromClient", func(t *testing.T) {
		rtype := reflect.TypeOf(NewDefaultClient())
		...
		t.Run("Returns fallback when not present", func(t *testing.T) {
			val := FromClient(context.Background())
	...
	t.Run("WithClient", func(t *testing.T) {
		...
		t.Run("Returns instance when present", func(t *testing.T) {
			...
			WithClient(ctx, func(obj Client) {
				if obj != inst {
		...
		t.Run("Returns fallback when not present", func(t *testing.T) {
			WithClient(context.Background(), func(obj Client) {
