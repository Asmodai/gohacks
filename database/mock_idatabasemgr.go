...
// Source: github.com/Asmodai/gohacks/database (interfaces: IDatabaseMgr)
...
func (m *MockIDatabaseMgr) CheckDB(arg0 IDatabase) error {
	m.ctrl.T.Helper()
...
func (m *MockIDatabaseMgr) Open(arg0, arg1 string) (IDatabase, error) {
	m.ctrl.T.Helper()
...
func (m *MockIDatabaseMgr) OpenConfig(arg0 *Config) (IDatabase, error) {
	m.ctrl.T.Helper()
